<?php
    ...
    if (isset($_POST["donecommand"])) {
        ...
        $insert_user = $conn -> prepare("INSERT INTO `histories` (id,command_id,name,phone,adresse,qty,product_id,product_price) Values (?,?,?,?,?,?,?,?)");
        $insert_user->execute([$id,$command_id,$name,$phone,$adresse,$qty,$product_id,$product_price]);
    }
...
<head>
    ...
    <title>elphasim Dashboard</title>
