<?php
    ...
    if (isset($_POST["submit"])) {
        ...
        $insert_user = $conn -> prepare("INSERT INTO `commands` (id,name,phone,adresse,qty,product_id,product_price) Values (?,?,?,?,?,?,?)");
        $insert_user->execute([$id,$name,$phone,$adresse,$qty,$product_id,$product_price]);
...
<body>
    ...
    <div class="landing">
        <div class="landing_container">
            ...
            <form action="" method="post">
                ...
                <div class="button_qty">
                    ...
                    <div class="qty">
                        ...
                        <input type="number" name="qty" class="qty_input" value="1" readonly>
            ...
            <div class="l_content">
                <div class="timer_promo"><div id="timer"></div></div>
                <div class="imgs">
